...
int main(const int argc, char **argv)
{
  ...
  TFLiteRun230::Args args(argc, argv);
  ...
  for (const auto &o : interpreter->inputs())
  {
    ...
    if (tensor->type == kTfLiteInt32)
    {
      ...
      auto tensor_view = TFLiteRun230::TensorView<int32_t>::make(*interpreter, o);
    ...
    else if (tensor->type == kTfLiteUInt8)
    {
      ...
      auto tensor_view = TFLiteRun230::TensorView<uint8_t>::make(*interpreter, o);
    ...
    {
      // Generate bool input
      auto tensor_view = TFLiteRun230::TensorView<bool>::make(*interpreter, o);
