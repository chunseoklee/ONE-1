...
#ifndef __NEURUN_IR_OPERATION_RESIZE_NEAREST_NEIGHBOR_H__
#define __NEURUN_IR_OPERATION_RESIZE_NEAREST_NEIGHBOR_H__
...
#endif // __NEURUN_IR_OPERATION_RESIZE_NEAREST_NEIGHBOR_H__
