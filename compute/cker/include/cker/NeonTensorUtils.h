    ...
    size_t cn_stride)
{
  ...
  do {
    ...
    const int32x4_t vmultiplier = vld1q_dup_s32(0);
    ...
    const int32x4_t vright_shift = vld1q_dup_s32(0);
    ...
    const int16x8_t voutput_zero_point = vld1q_dup_s16(0);
#if XNN_ARCH_ARM64
...
#endif
    const int8x16_t voutput_min = vld1q_dup_s8(0);
    const int8x16_t voutput_max = vld1q_dup_s8(0);
